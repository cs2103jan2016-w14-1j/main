...
public class QuoteStorage {
	...
	private static final String QUOTE_ONE = 
			"â€œHard work beats talent when talent fails to work hardâ€? "
					+ "-- Kevin Durant";
	private static final String QUOTE_TWO = 
			"â€œStrive not to be a success, but rather be a valueâ€? "
					+ "-- Albert Einstein";
	private static final String QUOTE_THREE = 
			"â€œThe secret of success is to do the common things uncommonly wellâ€? "
					+ "-- John D. Rockefeller";
	private static final String QUOTE_FOUR = 
			"â€œTwo roads diverged in a wood, and I took the one less traveled by, and that has made all the differenceâ€? "
					+ "-- Robert Frost";
	private static final String QUOTE_FIVE = 
			"â€œShould Plan A fails, remember, you have 25 letters leftâ€? "
					+ "-- Anonymous";
	private static final String QUOTE_SIX = 
			"â€œI won't run away anymore... I won't go back on my word... that is my ninja way!â€? "
					+ "-- Uzumaki Naruto";
	...
	private static final String QUOTE_EIGHT = 
			"â€œYour time is limited, so donâ€™t waste it living someone elseâ€™s lifeâ€? "
					+ "-- Steve Jobs";
	private static final String QUOTE_NINE = 
			"â€œPeople often say that motivation doesnâ€™t last. Well, neither does bathing. Thatâ€™s why we recommend it dailyâ€? "
					+ "-- Zig Ziglar";
	private static final String QUOTE_TEN = 
			"â€œYou can never cross the ocean until you have the courage to lose sight of the shoreâ€? "
					+ "-- Christopher Columbus";
	private static final String QUOTE_ELEVEN = 
			"â€œRemember no one can make you feel inferior without your consentâ€? "
					+ "-- Eleanor Roosevelt";
	...
	private static final String QUOTE_FOURTEEN = 
			"â€œIf you think you are too small to be effective, you have never been in the dark with a mosquitoâ€? "
					+ "-- Betty Reese";
	private static final String QUOTE_FIFTEEN = 
			"â€œAge is of no importance unless youâ€™re a cheeseâ€? "
					+ "-- Billy Burke";
	private static final String QUOTE_SIXTEEN = 
			"â€œAlways borrow money from a pessimist. He wonâ€™t expect it backâ€? "
					+ "-- Oscar Wilde";
	private static final String QUOTE_SEVENTEEN = 
			"â€œEvery walk starts with a stepâ€? "
					+ "-- Anonymous";
	private static final String QUOTE_EIGHTEEN = 
			"â€œIn my body, where the shame gland should be, there is a second awesome gland. True storyâ€? "
					+ "-- Barney Stinson";
	private static final String QUOTE_NINETEEN = 
			"â€œBelieve you can and you're halfway thereâ€? "
					+ "-- Theodore Roosevelt";
	private static final String QUOTE_TWENTY = 
			"â€œYour most unhappy customers are your greatest source of learningâ€? "
					+ "-- Bill Gates";
	private static final String QUOTE_TWENTYONE = 
			"â€œInnovation distinguishes between a leader and a followerâ€? "
					+ "-- Steve Jobs";
